...
import { ListaVoluntari } from './scenes/Voluntari/ListaVoluntari';
import { ModificaVoluntar } from './scenes/Voluntari/ModificaVoluntar';
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'lista',
            element: <ListaVoluntari />,
          },
          {
            path: ':id',
            element: <ModificaVoluntar />,
          },
        ],
      },
      {
